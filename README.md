...
<p align="center" style="font-size: 1.2em; color: #20B2AA;">
  I'm currently an intern at <strong>Bomare Company</strong>, manufacturers of <strong>STREAM</strong> and <strong>LG</strong> tvs and monitors, working on an assembly line detection system for faults and missing components in TV accessory bags, boxes, and on PCBs using <strong>Computer Vision</strong>.
</p>
